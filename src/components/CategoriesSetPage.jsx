...
class CategoriesSetPage extends Component {
    state = {}
    render() {
        return (
            <React.Fragment>
                <Container fluid>
                    <ul className="list-unstyled" >
                        <CategoriesPage image={Babka} author={this.getAuthor("Babka")} recipe={this.getRecipe("Babka")} />
                        <CategoriesPage image={Brownie} author={this.getAuthor("Brownie")} recipe={this.getRecipe("Brownie")} />
                        <CategoriesPage image={Profiterol} author={this.getAuthor("Profiterol")} recipe={this.getRecipe("Profiterol")} />
                    </ul>
                </Container>
            </React.Fragment>
